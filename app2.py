...
if uploaded_file is not None:
    ...
    with col1:
        ...
        selected_id_1_category = check_content_df.loc[check_content_df['key'] == id_1, 'category'].values[0]
        ...
        st.write(f'Title: ****{selected_id_1_title}****  Category: ****{selected_id_1_category}****')
    ...
    with col2:
        if not processing:
            ...
            selected_id_2_category = check_content_df.loc[check_content_df['key'] == id_2, 'category'].values[0]
            ...
            st.write(f'Title: ****{selected_id_2_title}****  Category: ****{selected_id_2_category}****')
